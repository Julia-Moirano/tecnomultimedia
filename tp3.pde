...
String [] nombredeboton= {"Comenzar","Créditos","SIGUIENTE","VOLVER AL INICIO","Sigues esperando","Bostezas"};
void setup(){
  size(600,600);
  background(0);
...
void draw(){
  ...
  if(estado==0){
    ...
    bloquedetexto(300,500,500,150,5);//500
    fill(125,125,190);
    textSize(17);
    ...
    bloquedetexto(300,100,500,150,5);
    fill(125,125,190);
    textSize(17);
    text(textobase[3],width/2,height/2-200,450,150);
     boton(450,215,anchoboton,altoboton,15);
     boton(450,335,anchoboton,altoboton,15);
     textSize(15);
     text(nombredeboton[4],500,240,100,50);
     textSize(20);
     text(nombredeboton[5],500,360);
  } else if(estado==5){
   image(imagenes[5],0,0,600,600);
   bloquedetexto(300,500,500,150,5);
    fill(125,125,190);
    textSize(17);
